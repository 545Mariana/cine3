...
<div class="form">
    ...
    <div class="form-panel one">
        ...
        <div class="form-content">
            <form id="frmRestro" method="POST" action="../Controlador/ControladorAutentificacion.php?op=registra">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="txtApellidos" name="txtApellidos" placeholder="Apellidos" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-info"><i class="fas fa-save"></i>Registrar</button>
                </div>
            </form>
        </div>
    </div>
