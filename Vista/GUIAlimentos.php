        ...
        <div class="container-fluid">
            ...
            <div class="offcanvas-body">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link mx-lg-2" data-page="peliculas"  href="index.php">INICIO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-lg-2" data-page="peliculas">Peliculas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-lg-2 active" aria-current="page" data-page="alimentos" href="GUIAlimentos.php">Alimentos</a>
                </li>
                <li class="nav-item">
        ...
        <!-- Galeria de combos -->
            ...
            if(isset($_POST['OrdenAlimento'])){
                ...
                if(trim($_POST['tipo'])=="alimento"){
                    ...
                    var_dump($controlador->gestor->carrito->numProductos);
                }
                        echo '<tfoot>';
                            echo '<tr>';
                                echo '<td><strong>Total</strong></td>';
